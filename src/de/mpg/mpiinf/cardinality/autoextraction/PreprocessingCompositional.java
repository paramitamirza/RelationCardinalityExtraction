...
public class PreprocessingCompositional {
	...
	public static void main(String[] args) throws Exception {
		...
		try {
			...
			formatter.printHelp("RelationCardinalityExtraction: PreprocessingCompositional", options);
...
//		String inputCsvFile = "./data/auto_extraction/wikidata_sample.csv";
		...
		if (extractFeature) {
			...
			if (inputRandomCsvFile == null) {
				...
				FeatureExtractionCompositionalForCRF featExtraction = new FeatureExtractionCompositionalForCRF(inputJsonFile, inputRandomCsvFile, relName, dirFeature);
