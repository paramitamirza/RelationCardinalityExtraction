...
public class FeatureExtractionCompositionalForCRF {
	...
	public FeatureExtractionCompositionalForCRF() {
		
	}
	
	public FeatureExtractionCompositionalForCRF(String inputJsonFilePath, String inputRandomCsvFilePath, String relationName, String dirOutput) {
		this();
	...
	public static void main(String[] args) throws JSONException, IOException {
		...
		FeatureExtractionCompositionalForCRF featExtraction;
		if (args.length < 4) {
			featExtraction = new FeatureExtractionCompositionalForCRF();
		} else {
			featExtraction = new FeatureExtractionCompositionalForCRF(args[0], args[1], args[2], args[3]);
		}
