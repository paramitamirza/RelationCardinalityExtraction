...
public class WikidataNumberOfChildren {
	
	public WikidataNumberOfChildren() {
		
	}

	public static void main(String[] args) {
		try {
			WikidataNumberOfChildren numOfChildren = new WikidataNumberOfChildren();
	...
	public void matchNumberOfChildren() throws JSONException, FileNotFoundException {
		...
		PrintWriter silverData = new PrintWriter(new File("./data/silver-cardinality.txt"));
		...
		for (int i=0; i<res.length(); i++) {
			...
			silverData.write("<" + entity + ">" + " <http://www.wikidata.org/prop/direct/P1971> \"" 
					+ numChild + "\"^^<http://www.w3.org/2001/XMLSchema#decimal> .\n");
		}
